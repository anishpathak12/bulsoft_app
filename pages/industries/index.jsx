          ...
          <div className="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div className="px-6 pb-6 ">
              ...
              <p className="text-gray-700 text-xl ">
                ...
                applications are required and expected to be interoperable
                across platforms, browsers, servers and languages, it is very
                much necessary that the end users of the products get security
                assurance of the personal and financial data, exhibit high
                performance, compatibility, security and usability..
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div className="px-6 py-6 ">
              ...
              <p className="text-gray-700 text-xl pb-24">
                ...
                double-quick time to market opportunities, service customers
                efficiently and effectively, ensure regulatory compliance, while
                ensuring risks are properly assessed and mitigated.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div className="px-6 py-6">
              ...
              <p className="text-gray-700 text-xl pb-16">
                ...
                migrations, etc. These conditions create a complex and dynamic
                environment for Banks and Financial Institutions, and are
                pressured to provide flexible payments systems to meet the
                changing demands.
              </p>
            </div>
          </div>
