...
const Management = ({img, heading1, heading2, para, list }) => {
    return (
      ...
      <div className="relative px-4 pt-12 pb-16 sm:px-6 sm:pt-16 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div className="lg:col-start-2 lg:pl-8">
          <div className="mx-auto max-w-prose text-base lg:ml-auto lg:mr-0 lg:max-w-lg">
            <h2 className="font-bold text-4xl leading-6 text-indigo-600">MANAGEMENT SERVICES</h2>
            <h3 className="mt-10 text-3xl font-semibold leading-8 tracking-tight text-gray-900 sm:text-4xl">Test Management</h3>
